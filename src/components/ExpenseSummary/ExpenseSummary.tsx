...
const ExpenseSummary: React.FC<ExpenseSummaryProps> = ({ 
  ...
  return (
    <section className="bg-white rounded-lg p-4 md:p-6 mb-8 shadow-sm border border-gray-200">
      <div className="flex justify-between items-center mb-5 pb-4 border-b border-gray-200 flex-col md:flex-row gap-3 text-center md:text-left">
        <h2 className='text-xl md:text-2xl font-bold text-gray-900 m-0'>Expense Summary</h2>
      ...
      <div className="flex gap-8">
        <div className="flex flex-col items-center flex-1">
          ...
          <span className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 text-center">{formattedTotal}</span>
        </div>
        
        <div className="flex flex-col items-center flex-1">
          <span className="text-sm font-medium text-gray-500 mb-2 text-center">Expenses</span>
          <span className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 text-center">{expenseCount}</span>
        </div>
      </div>
    </section>
  );
